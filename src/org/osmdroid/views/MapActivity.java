...
public abstract class MapActivity extends Activity {
        ...
        private class SampleLocationListener implements LocationListener {
                ...
                public void onLocationChanged(final Location loc) {
                        if (loc != null) {
                                if (MapActivity.this.mDoGPSRecordingAndContributing)
                                        MapActivity.this.mRouteRecorder.add(loc,
                                                        MapActivity.this.mNumSatellites);

                                MapActivity.this.onLocationChanged(loc);
                        } else {
                                MapActivity.this.onLocationLost();
                        }
                }
                ...
                public void onStatusChanged(final String a, final int i, final Bundle b) {
                        ...
                        MapActivity.this.mNumSatellites = b.getInt("satellites", NOT_SET);
                }
